...
> = {
  ...
  'experiment_detail-page': () => import('./experiment/detail-page/index.vue'),
  'experiment_form-page': () => import('./experiment/form-page/index.vue'),
  'experiment_list-page': () => import('./experiment/list-page/index.vue'),
  ...
  'model-park': () => import('./model-park/index.vue'),
